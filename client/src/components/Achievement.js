...
const Achievement = ({entries}) => {
    ...
    if (entries.length >= 0 && entries.length <= 4) {
        ...
        <div className='achievementBox'>
            <p>Level 1: Junior Chef - On your way to becoming a more mindful cooking master &#11088;</p>
        ...
        levelTracker =
        <div className='achievementBox'>
            <p>Congratulations: You have reached Level 2 and have been promoted to Chef de Partie!&#11088;&#11088;<i class="fa-light fa-hat-chef"></i></p>
        ...
        levelTracker =
        <div className='achievementBox'>
            <p>You have reached Level 3! You have been promoted to Sous Chef!&#11088;&#11088;&#11088;</p>
        ...
        levelTracker =
        <div className='achievementBox'>
            <p>Woah! You have reached level 4 and have been promoted to Head Chef! &#11088;&#11088;&#11088;&#11088;</p>
        ...
        levelTracker =
        <div className='achievementBox'>
            <p>You have reached level 5! After a month of mindful meals, you are now a Master of the Culinary Arts&#11088;&#11088;&#11088;&#11088;&#11088;</p>
        ...
        levelTracker =
        <div className='achievementBox'>
            <p>You have reached level 6! Holy moly! You are the envy of your peers!</p>
