...
function App() {
  ...
  const addNewEntry = (entry) => {
    postEntry(entry).then((savedEntry) => setEntries([...entries, savedEntry]));
  };
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/calendar"
            element={
              <CalendarWrapper entries={entries} handleDelete={handleDelete} />
            }
          />
          <Route
            path="/searchrecipes"
          ...
          <Route
            ...
            element={
              <Form
                onEntrySubmit={(entry) => addNewEntry(entry)}
                entries={entries}
              />
            }
          />
